...
void SvgRenderer::Serialiser_XML_writer(xercesc::DOMDocument* pDOMDocument, char* FullFilePath )
{
...
pSerializer->release();
    ...
    void SvgRenderer::outNodes(string basename, int steps, std::vector<neuralgas::Node> features)
    {
